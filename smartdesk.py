...
gyrosensorX = [0 for i in range(400)]
gyrosensorY = [0 for i in range(400)]

angleLine = np.linspace(-5,5,400)
hightLine = np.linspace(100, 220, 400)
pidLine = np.linspace(-1000,1000,400)
pwmLine = np.linspace(0,100,400)
...
line3 = ax1.plot(x_val, pidLine, color='blue')[0]   # pid
line4 = ax2.plot(x_val, angleLine, color='red')[0]  # angleX
line5 = ax2.plot(x_val, angleLine, color='blue')[0] # angleY
line6 = ax3.plot(x_val, pwmLine, color='red')[0]    # pwm A
line7 = ax3.plot(x_val, pwmLine, color='blue')[0]   # pwm B
